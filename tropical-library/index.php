...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-cards">
            <a href="?status=all" class="stat-card"><div class="stat-icon">🌴</div><div class="stat-number"><?= $total ?></div><div class="stat-label">Всего книг</div></a>
            <a href="?status=read" class="stat-card"><div class="stat-icon">🍍</div><div class="stat-number"><?= $read ?></div><div class="stat-label">Прочитано</div></a>
            <a href="?status=reading" class="stat-card"><div class="stat-icon">🌺</div><div class="stat-number"><?= $reading ?></div><div class="stat-label">Читаю</div></a>
            <a href="?status=want" class="stat-card"><div class="stat-icon">🥥</div><div class="stat-number"><?= $want ?></div><div class="stat-label">Хочу</div></a>
        </div>
